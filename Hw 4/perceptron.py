...
# SPECIFICATION : Simulate a grid search, trying to find which combination
#                 of two Perceptron hyperparameters (eta0, random_state)
#                 leads you to the best prediction performance
# FOR           : CS 4210 - Assignment #4
# TIME SPENT    : 04/08/2021-04/11/2021
#-------------------------------------------------------------------------
...
for a in n: # iterates over n
    for b in r: #iterates over r
        ...
        # Fit perceptron to the training data
        ...
        if accuracy > highest_accuracy:
            ...
            print("Highest Perceptron accuracy so far: " + str(highest_accuracy) + ", Parameters: learning rate=" + str(n_val) + ", random_state=" + str(r_val))
print("\nHighest Perceptron accuracy so far: " + str(highest_accuracy) + ", Parameters: learning rate=" + str(n_val) + ", random_state=" + str(r_val))
